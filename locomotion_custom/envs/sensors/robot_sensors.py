...
from locomotion_simulation.locomotion_custom.robots import minitaur_pose_utils
...
class BaseDisplacementSensor(sensor.BoxSpaceSensor):
  ...
  @property
  def x(self):
    return self._robot.GetBasePosition()[0]
  
  @property
  def y(self):
    return  self._robot.GetBasePosition()[1]
  
  @property
  def z(self):
    return  self._robot.GetBasePosition()[2]
